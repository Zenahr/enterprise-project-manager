        ...
        if(Auth::check()) {
            $company = Company::create([
                ...
                // 'user_id'=>$request->user()->id
                    ...
                    if($company) {
                        return redirect()->route('companies.show', ['company'=> $company->id])->with('success', 'Your company has been added successfully!');
                    }
        }

        return back()->withInput()->with('errors', 'Company creation unsuccessful');
    }
